...
JumperManager v1.2.0 is licensed under **AGPL-3.0-only**. The Linux standalone
...
[v1.2.0](https://github.com/pgq18/JumperManager/tree/v1.2.0).
...
- [JumperManager-Linux-x86_64.tar.gz](https://github.com/pgq18/JumperManager/releases/download/v1.2.0/JumperManager-Linux-x86_64.tar.gz):
...
The complete `JumperManager-Source-v1.2.0.zip` described in
...
Extract `JumperManager-Linux-Source-v1.2.0.tar.gz` and work from its project root.
...
the matching `JumperManager-Linux-Source-v1.2.0.tar.gz` alongside it. If rebuilding with
